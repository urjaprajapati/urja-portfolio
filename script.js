...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const TECH_ICONS = {
    ...
    'GitHub': `<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="11" fill="#161B22"/><path d="M12 6.2c-3.2 0-5.8 2.6-5.8 5.9 0 2.6 1.7 4.9 4 5.6.3.1.4-.1.4-.3v-1.2c-1.6.4-2-.7-2-.7-.3-.7-.7-.9-.7-.9-.5-.4.1-.4.1-.4.6 0 1 .6 1 .6.6 1 1.5.7 1.9.6.1-.5.2-.8.4-1-1.3-.1-2.7-.7-2.7-3 0-.6.2-1.2.6-1.6-.1-.1-.3-.7.1-1.5 0 0 .5-.2 1.7.6a5.7 5.7 0 013 0c1.2-.8 1.7-.6 1.7-.6.3.8.1 1.4.1 1.5.4.4.6 1 .6 1.6 0 2.3-1.4 2.8-2.7 3 .2.2.4.5.4 1.1v1.6c0 .2.1.4.4.3 2.3-.8 4-3 4-5.6 0-3.3-2.6-5.9-5.8-5.9z" fill="#fff"/></svg>`,
    'Tailwind CSS': `<svg viewBox="0 0 24 24"><path d="M7 10.5C7.6 8 9 6.7 11.5 6.7c3.5 0 3.9 2.6 5.7 3 1.2.3 2.2-.2 3-1.4-.6 2.5-2 3.8-4.5 3.8-3.5 0-3.9-2.6-5.7-3-1.2-.3-2.2.2-3 1.4z" fill="#38BDF8"/><path d="M2.5 16.9C3.1 14.4 4.5 13.1 7 13.1c3.5 0 3.9 2.6 5.7 3 1.2.3 2.2-.2 3-1.4-.6 2.5-2 3.8-4.5 3.8-3.5 0-3.9-2.6-5.7-3-1.2-.3-2.2.2-3 1.4z" fill="#38BDF8"/></svg>`,
    'Postman': `<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="11" fill="#FF6C37"/><path d="M12 5.5a6.5 6.5 0 100 13 6.5 6.5 0 000-13zm2.9 5.9l-3.3 3.3-.8-.8 2.5-2.5H10v-1.1h4.4l-1.6-1.6.8-.8 2.3 2.3v1.2z" fill="#fff"/></svg>`,
    'WooCommerce': `<svg viewBox="0 0 24 24"><rect width="24" height="24" rx="5" fill="#96588A"/><path d="M5 9h2.2l1 5 1.3-5h1.7l1.3 5 1-5H15l-2 8h-1.9l-1.2-4.6L8.7 17H6.8L5 9z" fill="#fff"/><path d="M17.5 9a3 3 0 100 6 3 3 0 000-6zm0 4.5a1.5 1.5 0 110-3 1.5 1.5 0 010 3z" fill="#fff"/></svg>`,
    'Notion': `<svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="3" fill="#fff"/><path d="M6.5 6.5v11l1.8-.1V9.6l6.4 7.9 2.3-.1V6.4l-1.8.1v7.7L8.9 6.4l-2.4.1z" fill="#111"/></svg>`,
    'Adobe XD': `<svg viewBox="0 0 24 24"><rect width="24" height="24" rx="5" fill="#2ADEF6"/><path d="M6 6h3.4l2.6 4.3L14.6 6H18l-4.3 6 4.5 6h-3.5l-2.8-4.6L9.1 18H5.7l4.5-6.1L6 6z" fill="#1a1a1a"/></svg>`,
    'Mailchimp': `<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="11" fill="#FFE01B"/><path d="M8 13c-.8 0-1.4-.5-1.4-1.2 0-1.6 2-3.3 3.9-3.3.6 0 1.1.2 1.4.5.6-.4 1.4-.6 2.1-.5-1.2.6-1.9 1.7-1.9 2.9 0 .3 0 .5.1.7-.5.2-1.1.3-1.6.2-.3.9-1.5 1.7-2.6 1.7z" fill="#1a1a1a"/><circle cx="15.5" cy="8.5" r="1" fill="#1a1a1a"/></svg>`,
    'Asana': `<svg viewBox="0 0 24 24"><circle cx="7" cy="15.5" r="3" fill="#F06A6A"/><circle cx="17" cy="15.5" r="3" fill="#F06A6A"/><circle cx="12" cy="8" r="3" fill="#F06A6A"/></svg>`,
    'Joomla': `<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="11" fill="#F44321"/><path d="M13 6.5a4 4 0 100 8 4.1 4.1 0 002-.5l1.5 1.5 1-1-1.5-1.5A4 4 0 0013 6.5zm0 1.7a2.3 2.3 0 110 4.6 2.3 2.3 0 010-4.6z" fill="#fff"/><path d="M9 10.5a3.3 3.3 0 100 6.6 3.4 3.4 0 001.6-.4l1.2 1.2.9-.9-1.2-1.2a3.3 3.3 0 00-2.5-5.3zm0 1.6a1.7 1.7 0 110 3.4 1.7 1.7 0 010-3.4z" fill="#fff"/></svg>`
  };
  ...
  const TECH = [
    ...
    { name: 'Tailwind CSS',   code: 'Tw',  color: '#38BDF8' },
    { name: 'WordPress',      code: 'Wp',  color: '#21759B' },
    { name: 'WooCommerce',    code: 'Wc',  color: '#96588A' },
    ...
    { name: 'Joomla',         code: 'Jm',  color: '#F44321' },
    ...
    { name: 'Adobe XD',       code: 'Xd',  color: '#2ADEF6' },
    { name: 'GitHub',         code: 'Gh',  color: '#161B22' },
    { name: 'Postman',        code: 'Pm',  color: '#FF6C37' },
    { name: 'Notion',         code: 'Nt',  color: '#111111' },
    { name: 'Asana',          code: 'As',  color: '#F06A6A' },
    { name: 'Mailchimp',      code: 'Mc',  color: '#FFE01B', dark: true }
  ];
